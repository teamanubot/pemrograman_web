...
<body>
    ...
    <div class="hero" id="hero">
        ...
        <h1>Selamat datang di API TeamAnuBot</h1>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            // Token input handler
            document.getElementById('api-token-input').addEventListener('input', function() {
            ...
            window.addEventListener('scroll', () => {
                ...
                const translateY = Math.max(-scrollY * 0.3, -maxTranslate);
